...
public class ControlForPosition_AngularStabilityReward : Agent
{
    Rigidbody rigidBody;
    ...
    [Tooltip("Angular-rate penalties use only the amount above this threshold.")]
    [SerializeField] float angularPenaltyDeadbandDegPerSec = 25f;
    [SerializeField] float angularVelocityPenaltyScale = 0.025f;
    [SerializeField] float yawRatePenaltyScale = 0.04f;
    [SerializeField] float rollPitchAnglePenaltyScale = 0.02f;
    [SerializeField] float nearTargetAngularVelocityPenaltyScale = 0.18f;
    [SerializeField] float nearTargetYawRatePenaltyScale = 0.35f;
    [SerializeField] float nearTargetRollPitchRatePenaltyScale = 0.12f;
    [SerializeField] float nearTargetRollPitchAnglePenaltyScale = 0.08f;
    [Tooltip("Yaw spin penalty starts only above this yaw-rate threshold. 0.4363 rad/s is 25 deg/s.")]
    [SerializeField] float spinDeadbandRadPerSec = 0.4363323f;
    [SerializeField] float spinPenaltyScale = 0.08f;
    [SerializeField] float nearTargetSpinPenaltyScale = 0.3f;
    [SerializeField] float speedNearTargetPenaltyScale = 0.06f;
    [SerializeField] float actionEnergyPenaltyScale = 0.002f;
    [SerializeField] float actionChangePenaltyScale = 0.0025f;
    ...
    float currentRollPitchAngle01;
    float currentSpinExcess;
    float currentNearTargetAngularPenalty;
    float lastStepReward;
    int stableSuccessStepCount;
    bool angularPenaltyBaselineCaptured;
    float baseAngularVelocityPenaltyScale;
    float baseYawRatePenaltyScale;
    float baseRollPitchAnglePenaltyScale;
    float baseNearTargetAngularVelocityPenaltyScale;
    float baseNearTargetYawRatePenaltyScale;
    float baseNearTargetRollPitchRatePenaltyScale;
    float baseNearTargetRollPitchAnglePenaltyScale;
    float baseSpinPenaltyScale;
    float baseNearTargetSpinPenaltyScale;
    ...
    public float CurrentRollPitchAngle01 => currentRollPitchAngle01;
    public float CurrentSpinExcess => currentSpinExcess;
    ...
    [ContextMenu("Capture Angular Penalty Baseline")]
    public void CaptureAngularPenaltyBaseline()
    {
        baseAngularVelocityPenaltyScale = angularVelocityPenaltyScale;
        baseYawRatePenaltyScale = yawRatePenaltyScale;
        baseRollPitchAnglePenaltyScale = rollPitchAnglePenaltyScale;
        baseNearTargetAngularVelocityPenaltyScale = nearTargetAngularVelocityPenaltyScale;
        baseNearTargetYawRatePenaltyScale = nearTargetYawRatePenaltyScale;
        baseNearTargetRollPitchRatePenaltyScale = nearTargetRollPitchRatePenaltyScale;
        baseNearTargetRollPitchAnglePenaltyScale = nearTargetRollPitchAnglePenaltyScale;
        baseSpinPenaltyScale = spinPenaltyScale;
        baseNearTargetSpinPenaltyScale = nearTargetSpinPenaltyScale;
        angularPenaltyBaselineCaptured = true;
    }

    public void ApplyAngularPenaltyMultipliers(
        float globalAngularScale,
        float yawScale,
        float nearTargetScale)
    {
        if (!angularPenaltyBaselineCaptured)
        {
            CaptureAngularPenaltyBaseline();
        }

        globalAngularScale = Mathf.Max(0f, globalAngularScale);
        yawScale = Mathf.Max(0f, yawScale);
        nearTargetScale = Mathf.Max(0f, nearTargetScale);

        angularVelocityPenaltyScale = baseAngularVelocityPenaltyScale * globalAngularScale;
        yawRatePenaltyScale = baseYawRatePenaltyScale * yawScale;
        rollPitchAnglePenaltyScale = baseRollPitchAnglePenaltyScale * globalAngularScale;
        nearTargetAngularVelocityPenaltyScale = baseNearTargetAngularVelocityPenaltyScale * nearTargetScale;
        nearTargetYawRatePenaltyScale = baseNearTargetYawRatePenaltyScale * nearTargetScale * yawScale;
        nearTargetRollPitchRatePenaltyScale = baseNearTargetRollPitchRatePenaltyScale * nearTargetScale;
        nearTargetRollPitchAnglePenaltyScale = baseNearTargetRollPitchAnglePenaltyScale * nearTargetScale;
        spinPenaltyScale = baseSpinPenaltyScale * yawScale;
        nearTargetSpinPenaltyScale = baseNearTargetSpinPenaltyScale * nearTargetScale * yawScale;
    }
    ...
    void FixedUpdate()
    {
        ...
        {
            // Some FinsROV prefabs keep a disabled DecisionRequester from an older Agent.
            RequestDecision();
        }
    }
    ...
    public override void OnEpisodeBegin()
    {
        ...
        currentRollPitchAngle01 = 0f;
        currentSpinExcess = 0f;
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        float rollPitchRate = new Vector2(localAngularVelocity.x, localAngularVelocity.z).magnitude;
        ...
        float yawRateExcess = Mathf.Max(0f, yawRate - angularPenaltyDeadband);
        float rollPitchRateExcess = Mathf.Max(0f, rollPitchRate - angularPenaltyDeadband);
        float rollPitchAngle01 = GetRollPitchAngle01(reference);
        float spinExcess = Mathf.Max(0f, yawRate - Mathf.Max(0f, spinDeadbandRadPerSec));
        float nearTargetAngularPenalty =
            nearTargetGain * (
                nearTargetAngularVelocityPenaltyScale * angularSpeedExcess * angularSpeedExcess +
                nearTargetYawRatePenaltyScale * yawRateExcess * yawRateExcess +
                nearTargetRollPitchRatePenaltyScale * rollPitchRateExcess * rollPitchRateExcess +
                nearTargetRollPitchAnglePenaltyScale * rollPitchAngle01 * rollPitchAngle01 +
                nearTargetSpinPenaltyScale * spinExcess * spinExcess
            );
        ...
        float reward =
            ...
            yawRatePenaltyScale * yawRateExcess * yawRateExcess -
            rollPitchAnglePenaltyScale * rollPitchAngle01 * rollPitchAngle01 -
            spinPenaltyScale * spinExcess * spinExcess -
        ...
        currentRollPitchAngle01 = rollPitchAngle01;
        currentSpinExcess = spinExcess;
        ...
        if (enableStatsRecorder)
        {
            ...
            Academy.Instance.StatsRecorder.Add("FinsROV/roll_pitch_angle01", rollPitchAngle01);
            Academy.Instance.StatsRecorder.Add("FinsROV/spin_excess", spinExcess);
    ...
    void ResolveRuntimeReferences()
    {
            ...
            out string statusMessage))
        {
            ...
            {
                Debug.Log($"[{nameof(ControlForPosition_AngularStabilityReward)}] {statusMessage}", this);
                logThrusterResolution = false;
            }
        }
        else
        {
            Debug.LogError($"[{nameof(ControlForPosition_AngularStabilityReward)}] {statusMessage}", this);
        }
    }
    ...
    float GetRollPitchAngle01(Transform reference)
    {
        Vector3 projectedUp = Vector3.ProjectOnPlane(reference.up, Vector3.up);
        return Mathf.Clamp01(projectedUp.magnitude);
    }
