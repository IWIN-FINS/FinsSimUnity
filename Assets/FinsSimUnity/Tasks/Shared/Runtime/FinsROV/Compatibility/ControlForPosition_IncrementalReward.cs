...
public class ControlForPosition_IncrementalReward : Agent
{
    Rigidbody rigidBody;
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        float reward =
            ...
            angularVelocityPenaltyScale * RigidBody.angularVelocity.magnitude -
        ...
        if (distanceToTarget < successDistance && headingError01 < successHeadingAngleDeg / 180f)
        {
    ...
    void ResolveRuntimeReferences()
    {
            ...
            out string statusMessage))
        {
            ...
            {
                Debug.Log($"[{nameof(ControlForPosition_IncrementalReward)}] {statusMessage}", this);
                logThrusterResolution = false;
            }
        }
        else
        {
            Debug.LogError($"[{nameof(ControlForPosition_IncrementalReward)}] {statusMessage}", this);
        }
    }
