...
namespace FinsSim.Communications.Acoustics
{
    public class Nanomodem : AcousticDevice<NanomodemMessage>
    {
        ...
        AcousticTransmiterParams _transmiterParams;
        ...
        public void Awake()
        {
            ...
            _transmiterParams = new AcousticTransmiterParams
            {
                ...
                Action<NanomodemMessage> onTimeoutCallback=null)
        {
            ...
            msg.TransmiterParams = _transmiterParams;
        ...
        private AcousticTransmiterParams GetPhysicalParams() =>
            _transmiterParams;
