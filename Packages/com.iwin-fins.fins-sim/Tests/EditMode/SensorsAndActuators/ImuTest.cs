...
using UnityEngine;
using FinsSim.Sensors.Primitive;
using TestUtils;
...
public class ImuTest
{
    ...
    public void SetUp()
    {
        ...
        _imu.AccelerometerNoise.NoiseTypeFullName = "FinsSim.NoiseDistributions.Noise+NoNoise";
        _imu.AccelerometerNoise.ParameterKeys = new List<string>();
        _imu.AccelerometerNoise.ParameterValues = new List<string>();

        _imu.GyroNoise.NoiseTypeFullName = "FinsSim.NoiseDistributions.Noise+NoNoise";
        _imu.GyroNoise.ParameterKeys = new List<string>();
        _imu.GyroNoise.ParameterValues = new List<string>();

        _imu.OrientationNoise.NoiseTypeFullName = "FinsSim.NoiseDistributions.Noise+NoNoise";
