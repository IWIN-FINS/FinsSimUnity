...
public class RosConnectionTest
{
    ...
    [UnityTest]
    public IEnumerator TestInstanceCreatedAndConnected()
    {
    ...
    [UnityTest]
    public IEnumerator TestAddAndGetClient()
    {
        yield return null;
    ...
    [UnityTest]
    public IEnumerator TestTfHandlerInit()
    {
    ...
    [UnityTest]
    public IEnumerator TestTfHandlerSetGeoFrameDefault()
    {
        Thread.Sleep(1000);
    ...
    [UnityTest]
    public IEnumerator TestTfHandlerSetGeoFrame()
    {
    ...
    [UnityTest]
    public IEnumerator TestTimeHandler()
    {
        ...
        Utils.CallNonpublicMethod(TimeHandler.Instance, "UpdateTime");
        yield return null;
        Assert.AreEqual(currTime + 4 * Time.fixedDeltaTime, TimeHandler.Instance.TimeDouble, 1e-2);
    }
